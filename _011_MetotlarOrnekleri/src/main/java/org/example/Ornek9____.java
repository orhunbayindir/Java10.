...
public class Ornek9____ {


    public Ornek9____(String adiSoyadi, int yasi, Boolean araclariVarMi ) {
        System.out.println("Yapıcı metot.");
    }

    public Ornek9____(String adiSoyadi, int yasi) {
        System.out.println("Yapıcı metot.");
    }

    public Ornek9____(String adiSoyadi, int boyu, int kilo) {
        System.out.println("Yapıcı metot.");
    }

    public Ornek9____(String adiSoyadi) {
        System.out.println("Yapıcı metot.");
    }
   ...
   //     VARLIK         YOKLUK
    //     new    -----   null
        Ornek9____ nesne1 = new Ornek9____("Gizem");

        Ornek9____ nesne2 = new Ornek9____("Gizem");
