...
public class PersonelManager implements IIslev {
    ...
    public void defPersonelOlustur() {
        Mudur mudur = new Mudur("Faruk", 61, 100000f, LocalDate.of(2000, 2, 1));
        Mudur mudur1 = new Mudur("Zübeyde", 60, 90000f, LocalDate.of(2006, 3, 1));
        Hizmetli hizmetli1 = new Hizmetli("İdil", 20, 11000f, LocalDate.of(2014, 1, 1));
        GenelMudur genelMudur = new GenelMudur("Mina", 25, 30000f, LocalDate.of(2019, 8, 1));
        InsanKaynaklari insanKaynaklari = new InsanKaynaklari("Ceren", 23, 13000f, LocalDate.of(2019, 6, 1));
        TeknikPersonel teknikPersonel = new TeknikPersonel("Oguz", 21, 14000f, LocalDate.of(2019, 6, 1));
        BuroPersoneli buroPersoneli = new BuroPersoneli("Esra", 25, 15000f, LocalDate.of(2019, 6, 1));
        MuhasebePersoneli muhasebePersoneli = new MuhasebePersoneli("Eyüp", 35, 16000f, LocalDate.of(2012, 6, 1));
