...
public class Ucak {
   ...
   static int pilotSayi;
    ...
    public Ucak(float uzunluk, float yükseklik, int hizi, float ağırlık) {//ucakkonumdurumunu çalışma zamanında değişebilceği için en yüksek hız sabit
    ...
    public Ucak(float uzunluk, float yükseklik) {
        this.uzunluk = uzunluk;
        this.yükseklik = yükseklik;
       // ++toplamUcakSayisi;
    }
